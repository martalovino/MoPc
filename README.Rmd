...
2. A map with all the miRNA drivers found in the dataset (in red, those enriched in at least one of mirDB, TargestScan, mirTarbase);
3. A report of the enrichment values in the three databases mirDB, TargestScan, mirTarbase by hypergeometric test.
